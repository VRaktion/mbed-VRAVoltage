...
void VRAVoltage::init_batteryChk() {
  ...
  batteryChk->writeReg(MAX17055::V_EMPTY,
                       (uint16_t)0xABE0); // empty voltage in mV * 16 (2,75V)
  batteryChk->writeReg(
      MAX17055::I_CHG_TERM,
      (uint16_t)0x0668); // charge termination current in mA * 6,4
...
int VRAVoltage::max17055ToCelsius(int val) { return val / 256; }
